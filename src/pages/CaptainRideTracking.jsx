...
const CaptainRideTracking = () => {
    ...
    const callPassenger = () => {
        if (rideData?.userPhone) {
            window.open(`tel:${rideData.userPhone}`, '_self');
        }
    };
        ...
        <div className="h-screen bg-gray-50 flex flex-col">
            ...
            <div className="bg-white shadow-sm p-4 z-10">
                <div className="flex items-center justify-between">
                    ...
                    <h1 className="text-lg font-semibold">Trip in Progress</h1>
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white rounded-lg shadow-lg p-4">
                        ...
                        <div className="flex items-center space-x-3">
                            <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                                <span className="font-bold text-purple-600">
                                    {(typeof rideData.userName === 'string' ? rideData.userName : 'P').charAt(0).toUpperCase()}
                                </span>
                            </div>
                            <div>
                                <h3 className="font-semibold text-gray-800">Passenger: {rideData.userName || 'User'}</h3>
                                <p className="text-sm text-gray-600">Trip ID: {rideData.rideId?.slice(-6) || 'N/A'}</p>
                            </div>
                        </div>
                        <div className="text-right">
                            <p className="text-sm text-gray-600">ETA</p>
                            <p className="font-bold text-lg text-purple-600">{estimatedTime} min</p>
                        </div>
                    </div>
                    ...
                    <div className="border-t pt-3 mb-3">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="text-right">
                                <p className="text-sm text-gray-600">OTP Used</p>
                                <p className="font-semibold text-gray-800">{otp || 'N/A'}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        <button
                            ...
                            className="bg-green-600 text-white py-2 rounded-lg font-medium hover:bg-green-700 transition-colors flex items-center justify-center"
                        >
                        ...
                        <button
                            ...
                            className="bg-purple-600 text-white py-2 rounded-lg font-medium hover:bg-purple-700 transition-colors flex items-center justify-center"
                        >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="grid grid-cols-4 gap-2 mt-2 text-xs text-center text-gray-600">
                        <span>Call</span>
                        <span>Chat</span>
                        <span>SOS</span>
                        <span>Complete</span>
...
export default CaptainRideTracking;
